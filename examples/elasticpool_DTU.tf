...
module "mssql" {
  ...
  db_names = {
    "elasticpoolbasic"      = { sku = "ElasticPool", elasticpool = "dtu_pool001" }
    "elasticpoolallconfigs" = { sku = "ElasticPool", elasticpool = "dtu_pool002", collation = "SQL_Latin1_General_CP1_CI_AS", max_size_gb = 32, min_capacity = 0.5, str_days = 7, ltr_monthly_retention = "P1Y", ltr_weekly_retention = "P1W", ltr_yearly_retention = "P1Y", ltr_week_of_year = "52" }
  ...
  ep_names = {
    "dtu_pool001" = { max_size_gb = 4.8828125, sku = "BasicPool", tier = "Basic", capacity = 50, max_capacity = 5, min_capacity = 0 }
    "dtu_pool002" = { max_size_gb = 4.8828125, sku = "BasicPool", tier = "Basic", capacity = 50, max_capacity = 5, min_capacity = 0 }
  }
