...
module "mssql" {
  ...
  db_names = {
    "hyperscalebasic"      = { sku = "HS_Gen5_2" }
    "hyperscaleallconfigs" = { sku = "HS_Gen5_2", collation = "SQL_Latin1_General_CP1_CI_AS", max_size_gb = 32, min_capacity = 0.5, str_days = 7, ltr_monthly_retention = "P1Y", ltr_weekly_retention = "P1W", ltr_yearly_retention = "P1Y", ltr_week_of_year = "52", read_replica_count = 0 }
  }
