module "mssql" {
  ...
  db_names = {
    "elasticpoolbasic"      = { sku = "ElasticPool" },
    "elasticpoolallconfigs" = { sku = "ElasticPool", collation = "SQL_Latin1_General_CP1_CI_AS", max_size_gb = 32, min_capacity = 0.5, str_days = 7, ltr_monthly_retention = "P1Y", ltr_weekly_retention = "P1W", ltr_yearly_retention = "P1Y", ltr_week_of_year = "52" }
  }
  ...
  ep_names = [
    { name = "vcorepool", max_size_gb = 120, sku = "GP_Gen5", tier = "GeneralPurpose", capacity = 2, max_capacity = 2, min_capacity = 0.25, family = "Gen5" }
  ]
