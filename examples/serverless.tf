...
module "mssql" {
  ...
  db_names = {
    "serverlessbasic"      = { sku = "GP_S_Gen5_2" }
    "serverlessallconfigs" = { sku = "GP_S_Gen5_2", collation = "SQL_Latin1_General_CP1_CI_AS", max_size_gb = 32, min_capacity = 0.5, auto_pause_delay_in_minutes = 1, str_days = 7 }
  }
